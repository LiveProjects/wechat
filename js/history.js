    	...
    	var target=e.target;
     	$.ajax({
        	...
        	success:function(data){
        		...
        		//$("#timemore").css({"display":"block","margin":"0 auto"});
        		if(data==0){
        			alert("请输入正确时间");
        		}else if(data==1){
...
//				long();
	...
	/************************************获取单位**********************************/
	$("#edit-main dl dt").next().next().find("input").focus(function(){
